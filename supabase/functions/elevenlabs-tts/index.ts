...
serve(async (req) => {
  ...
  try {
    ...
    if (!text) {
      console.error('[elevenlabs-tts] Missing text');
      return new Response(
    ...
    // Use provided voiceId or default to Rachel (warm, friendly female voice)
    ...
    // Convert audio to base64 for easy frontend consumption
